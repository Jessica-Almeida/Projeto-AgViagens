...
<header>
	...
	<main class="container jumbotron bg-light my-5 shadow col-12 col-md-6">
		<h2 class="text-center pt-4">ATUALIZAÇÃO - COMPRA</h2>
		<form action="./compra-update" class="m-5">
			...
			<div class="form-floating mb-3">
				<input type="number" name="qnt" class="form-control"
					placeholder="nome" value="<%=request.getAttribute("qnt")%>"
					required> <label>Quantidade</label>
			</div>
			<div class="form-floating mb-3">
				<input type="number" name="idDestino" class="form-control"
					placeholder="id" value="<%=request.getAttribute("idDestino")%>">
				<label>ID destino</label>
			</div>
			<div class="form-floating mb-3">
				<input type="number" name="idCliente" class="form-control"
					placeholder="id" value="<%=request.getAttribute("idCliente")%>">
